...
public class Test2 {
    ...
    public void sepeteekledekupontanimi() throws InterruptedException {
        ...
        //kampanyo kodu bulunamadı yazısı gözükmeli
        boolean label=driver.findElement(By.className("js-show-used-coupon-error")).isDisplayed();
    ...
    public void siparistakibi() throws InterruptedException {
        ...
        //Girdiğiniz sipariş numarası veya e-posta hatalıdır. yazisi alindi.
        boolean label2=driver.findElement(By.className("js-order-tracking-message")).isEnabled();
        Thread.sleep(1000);
